...
public class FunctionEnvironmentFactoryImpl implements FunctionEnvironmentFactory {
    @Override
    public FunctionEnvironment create(FunctionDeclarationEnvironment parent, @Nullable UUID startLabel, @Nullable UUID endLabel, @Nullable DataType returnDataType, boolean isShared, Set<Modifier> modifiers) {
        return new FunctionEnvironmentImpl(parent, startLabel, endLabel, returnDataType, isShared, modifiers);
    }
}
