...
public class MeazyClassEnvironment extends BasicClassEnvironment {
    public MeazyClassEnvironment(Environment parent) {
        ...
        declareVariable("VERSION", DataTypes.STRING(), new StringValue(MeazyMain.VERSION), true, Set.of(AccessModifiers.SHARED()));
        ...
        declareFunction(new DefaultFunctionValue("getAddons", new ArrayList<>(), DataTypes.parse("List"), this, Set.of(AccessModifiers.SHARED())) {
