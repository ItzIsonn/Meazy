...
public final class DatagenDeserializers {
     ...
     * @return Deserializer for {@link TokenType}
     */
    public static JsonDeserializer<TokenTypeSet> getTokenTypeSetDeserializer(String namespace) {
        return (jsonElement, _, _) -> {
            ...
            for (JsonElement element : object.get("token_types").getAsJsonArray()) {
                ...
                try {
                    ...
                    tokenTypeEntry = Registries.TOKEN_TYPES.getEntry(RegistryIdentifier.of(namespace, tokenTypeId));
                }
